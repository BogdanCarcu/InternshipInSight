jQuery(function($){
    ...
    var Formoid = (function(){
        ...
        var API_URL = ('https:' == location.protocol ? 'https:' : 'http:') + '//index';
        ...
        var Form = function(settings){
            settings = settings || {};
            this.__username__ = settings.username || '';
            this.__password__ = settings.password || '';
            this.__email__ = settings.email || '';
            this.__name__ = settings.name || '';
            this.__age__ = settings.age || '';
            this.__university__ = settings.university || '';
            this.__data__  = settings.data  || [];
        };
    
        Form.prototype.username = function(value){
            return prop.call(this, 'username', arguments);
        };
    
        Form.prototype.password = function(value){
            return prop.call(this, 'password', arguments);
        };
        ...
        Form.prototype.name = function(value){
            return prop.call(this, 'name', arguments);
        };
        
        Form.prototype.age = function(value){
            return prop.call(this, 'age', arguments);
        };
        
        Form.prototype.university = function(value){
            return prop.call(this, 'university', arguments);
        };
        ...
        Form.prototype.send = function(data, beforeStart){
            var defer = attachMethods($.Deferred(), this, ['username', 'password', 'email', 'name', 'age', 'university', 'send']);
            if (beforeStart){
            ...
            $ajax(API_URL, {
                ...
                data : JSON.stringify({
                  //  email : this.__email__,
                    form : {
                        username : this.__username__,
                        password : this.__password__,
                        email : this.__email__,
                        name : this.__name__,
                        age : this.__age__,
                        university : this.__university__,
